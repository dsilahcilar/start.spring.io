...
public class ParameterSection implements Section {
    ...
    public ParameterSection(String name, String displayName, String type, String defaultValue) {
        this.name = name;
    ...
    public void write(PrintWriter writer) throws IOException {
        ...
        writer.println(" - displayName" + this.displayName);
        writer.println(" - type" + this.type);
        writer.println(" - defaultValue" + this.defaultValue);
        writer.println("");
    }
