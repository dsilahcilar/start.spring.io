...
const config = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      title: 'Merak Initializr',
      description: `Initializr generates spring boot project with just what you need to start quickly!`,
      url: 'https://start.spring.io',
      twitter: '@springboot',
      image: 'src/images/initializr-icon.png',
      theme: `#FF6200`,
    }),
    new WebpackGoogleTagManager(process.env.GOOGLE_TAGMANAGER_ID),
    new WebpackPwaManifest({
      name: 'merak-initializr',
      short_name: 'Start',
      description: `Initializr generates merak project with just what you need to start quickly!`,
